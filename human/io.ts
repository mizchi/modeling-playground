...
export function inspectMotionGlb(buffer: ArrayBuffer) {
...
export async function loadMotionGlb(buffer: ArrayBuffer) {
  inspectMotionGlb(buffer);
  return new GLTFLoader().parseAsync(buffer,'');
}

export function downloadFile(data: Blob | BlobPart,name: string,type: string) {
