...
import { paintAshleyFace } from './face.ts';
...
}).map(([key,value])=>[key,Object.freeze(value as [number,number,number,number])])));
...
export function createAshleyAtlas() {
  ...
  const colors: Record<string,string>={face:'#b9a17b',skin:'#b69a70',hair:'#684321',bib:'#b4b4a5',leather:'#8a5b2c',
