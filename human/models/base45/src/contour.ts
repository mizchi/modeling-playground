...
type Contour = ReturnType<typeof appendContourColumns>;
...
export function contourTurn(previous: number[],a: number[],b: number[],t: number) {
...
export function appendContourColumns(builder: TopologyBuilder, original: number[]) {
...
export function bridgeContour(builder: TopologyBuilder, previous: Contour | undefined, next: Contour, neckLoop: number[]) {
  for(const [key,name,index] of [['positive','Left',2],['negative','Right',9]] as const) {
