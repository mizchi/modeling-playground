import type { HumanBodyShape } from './contract.ts';
import type { PointKind, HumanPoint } from './shape.ts';
const ANKLE=.16,HIP=1.025;
export const heightScale=(bodyShape: HumanBodyShape)=>1+.25*bodyShape.height;
...
export function applyProportions(point: HumanPoint,bodyShape: HumanBodyShape,kind: PointKind): HumanPoint {
