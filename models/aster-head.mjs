...
import { createAsterAtlas, ASTER_ATLAS, asterFaceUV } from './aster-texture.mjs';
...
function shapeSkin(geometry) {
  geometry.scale(...ASTER.faceScale);
...
export function createAsterHead() {
  ...
  for(let r=0;r<rows.length-1;r++) {
    ...
    for(const [i,normal] of [[0,[0,-1,0]],[5,[0,1,0]]])if(r===(i===0?0:4))
