...
export function sweep(rows,sides=8) {
...
export function triangles(vertices,indices) {
...
export function part(root,name,materials) {
  const group=new Group();group.name=name;group.userData.focusTarget=true;root.add(group);
  const buckets=new Map();let serial=0;
  return {
    group,
    add(geometry,color,key='hide',shade=null) {
...
export function plate(points,lift=.05) {
