...
export function solveTwoBone(start: Vector3, target: Vector3, pole: Vector3, upperLength: number, lowerLength: number) {
 ...
 */
export function solveHorizontalSweep({chest,shoulder,sweep,weight,elbowDrop,restUpper,restForearm}: {chest: Quaternion; shoulder: Quaternion; sweep: number; weight: number; elbowDrop: number; restUpper: Quaternion; restForearm: Quaternion}) {
