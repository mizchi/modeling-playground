...
import { createAshley } from '../human/models/ashley/src/model.ts';
import { createAshleyAtlas, ASHLEY_TILES } from '../human/models/ashley/src/texture.ts';
...
test('textured Ashley exports reproducibly as a self-contained, valid GLB with a PNG atlas',async()=>{
  ...
  assert.deepEqual(bytes,await readFile(new URL('../human/models/ashley/output/ashley.glb',import.meta.url)));
