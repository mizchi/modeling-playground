...
import { createBase45Inspection, faceCheckUV } from '../human/models/base45/src/inspection.ts';
...
test('face check exports reproducibly with an embedded texture and matches the delivered GLB',async()=>{
  ...
  assert.deepEqual(buffer,await readFile(new URL('../human/models/base45/output/base45-face-check.glb',import.meta.url)));
});
