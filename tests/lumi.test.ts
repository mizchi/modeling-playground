...
import { createLumiTexture, lumiFaceUV, LUMI_EYE_CENTER_X } from '../human/models/lumi/src/texture.ts';
import { LUMI_FRINGE, lumiForeheadZ } from '../human/models/lumi/src/hair-definition.ts';
import { lumiCapFaces } from '../human/models/lumi/src/cap.ts';
...
test('LUMI is deterministic and exports an embedded face texture and both skeletons',async()=>{
  ...
  assert.deepEqual(bytes,await readFile(new URL('../human/models/lumi/output/lumi.glb',import.meta.url)));
