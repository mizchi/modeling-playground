...
test('production site loads every GLB under the Pages subdirectory',async({page})=>{
  ...
  const models=['traveler','traveler-walk','traveler-ik','little-town','raven','bastion','strix','ashley','wyvern','dog','corgi','corgi-chibi','fes256','aster','base45','base45-face-check','suzu'];
